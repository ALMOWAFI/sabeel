...
export const API_ENDPOINTS = {
  ...
  APPWRITE: `${API_BASE_URL}/api/appwrite`,
  TENSORFLOW: `${API_BASE_URL}/api/tensorflow`,
  TEXT_ANALYSIS: `${API_BASE_URL}/api/tensorflow/analysis`,
  RECOMMENDATIONS: `${API_BASE_URL}/api/tensorflow/recommendations`,
};
